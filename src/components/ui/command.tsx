  ...
  return (
    <Dialog {...props}>
      <DialogContent className="shadow-shadow overflow-hidden rounded-none! border-0 p-0">
        ...
        <Command className="**:[[cmdk-group-heading]]:font-heading **:data-[slot=command-input-wrapper]:h-12 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5 **:[[cmdk-group-heading]]:mb-1 **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group]]:px-2 **:[[cmdk-input]]:h-12 **:[[cmdk-item]]:px-2 **:[[cmdk-item]]:py-3">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
...
>(({ className, wrapperClassName, ...props }, ref) => (
  <div
    ...
    className={cn(
      "flex h-9 items-center gap-2 border-b-2 border-stone-800 px-3",
      wrapperClassName
    )}>

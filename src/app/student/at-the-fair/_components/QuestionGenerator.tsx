...
export function QuestionGenerator() {
    ...
    return (
        <div className="mt-2 min-h-48 min-w-48 place-items-center text-center rounded-2xl p-5 border-emerald-900 border-2 bg-gradient-to-br from-emerald-950 to-liqorice-700">
            ...
            <button
                ...
                className="rounded-lg bg-emerald-700 p-3 spinning-border hover:bg-emerald-600 hover:scale-105 active:scale-95">
                Generate Question
            </button>
        </div>
    );
